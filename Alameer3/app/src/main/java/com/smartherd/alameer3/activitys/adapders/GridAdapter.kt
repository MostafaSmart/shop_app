...
class GridAdapter(val prodacts:ArrayList<Prodacts>,val prodId:ArrayList<String>,val dolar:String,val context: Context,val userLoca:String): BaseAdapter() {
